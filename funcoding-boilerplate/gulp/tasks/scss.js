...
import gulpSass from "gulp-sass"; // gulp용 Sass
...
const sassTranspile = gulpSass(dartSass);
...
const commonPostcssConfig = [presetEnvConfig];
// 개발 환경에서 사용할 PostCSS 플러그인을 정의합니다.
const postcssDevConfig = [presetEnvConfig];
